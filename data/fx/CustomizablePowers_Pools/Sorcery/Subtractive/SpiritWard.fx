	...
	Condition
		...
		Event
			...
			BhvrOverride
				PyrRotate -90 180 0
			End
			Part CustomizablePowers_Pools\Sorcery\Subtractive\Enchant_Rune_Smoke_Add.part
			Part CustomizablePowers_Pools\Sorcery\Subtractive\Enchant_Rune_Smoke.part
		End
	...
	Condition
		...
		Event
			...
			BhvrOverride
				PyrRotate -90 180 0
			End
			Part CustomizablePowers_Pools\Sorcery\Subtractive\Enchant_Rune.part
		End
