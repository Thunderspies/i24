...
###########################################################
	...
	Condition
		...
		Event
			...
			Type Posit
			EName Fire
	#		Part WeaponFX/FireExplosion.part
			LifeSpan 8
		End
		...
		Event
			...
			Type Posit
			EName Sparks
			Part CustomizablePowers_Pools\Epic_WeaponMastery\GernadeLauncherSparks.part
			Part CustomizablePowers_Pools\Epic_WeaponMastery\FireExplosion.part
