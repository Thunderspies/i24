...
###########################################################
	...
	Condition
		...
		Event
			...
			BhvrOverride
				PyrRotate -90 180 0
			End
			Part CustomizablePowers_Pools\Sorcery\Subtractive\Enflame_Rune_Smoke.part
			Part CustomizablePowers_Pools\Sorcery\Subtractive\Enflame_Rune_Smoke_Add.part
		End
	...
	Condition
		...
		Event
			...
			BhvrOverride
				PyrRotate -90 180 0
			End
			Part CustomizablePowers_Pools\Sorcery\Subtractive\Enflame_Rune.part
			Lifespan 15
		End
	...
	Condition
		...
		Event
			...
			Part CustomizablePowers_Pools\Sorcery\Subtractive\Enflame_Rune_Smoke_Out.part
