...
Condition
	...
	Event
		...
		Type	Local
		At	Chest
		Bhvr	CustomizeablePowers\EnergyMelee\CameraShake05Subtle.bhvr
		BhvrOverride
			Shake			0.5
			ShakeFallOff		0.025
			ShakeRadius		32.0
		End
		Part	CustomizeablePowers\EnergyMelee\EnergyTransfer_Hit_ExplosiveFlash.part
		Part	CustomizeablePowers\EnergyMelee\EnergyTransfer_Hit_ExplosiveRings.part
		#Part	CustomizeablePowers\EnergyMelee\EnergyTransfer_Hit_ExplosiveRays.part
		PMagnet	Chest
		LifeSpan 5
	End
