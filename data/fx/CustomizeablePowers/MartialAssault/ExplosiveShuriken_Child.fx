...
###########################################################
	...
	Condition
		...
		Event
			...
			Part CustomizeablePowers\MartialAssault\AreaFireB.part
			Part CustomizeablePowers\MartialAssault\AreaFireB_Mult.part
			Part CustomizeablePowers\MartialAssault\AreaFire.part
			Part CustomizeablePowers\MartialAssault\AreaFire_Mult.part
		...
		Event
			...
			Type StartPositOnly
			EName FireBallHit
			Part CustomizeablePowers\MartialAssault\Smoke.part
