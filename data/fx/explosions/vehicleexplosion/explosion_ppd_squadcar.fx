...
####################  Trunk  ###############################
	...
	Event
		...
		Geom	carpart_squadcar_trunk
		Bhvr	:PhysicsDebrisFade.bhvr
		BhvrOverride
			PositionOffset		0 1.5 -6.5
...
####################  Doors  ###############################
	...
	Event
		...
		Geom	carpart_squadcar_Door_FR
		Bhvr	:PhysicsDebrisFade.bhvr
		BhvrOverride
			PositionOffset		3 1 .5
	...
	Event
		...
		Geom	carpart_squadcar_Door_BR
		Bhvr	:PhysicsDebrisFade.bhvr
		BhvrOverride
			PositionOffset		3 1 -2.5
...
####################  LightBar  ###############################
	...
	Event
		...
		BhvrOverride
			...
			Spin			0.0 0.0 0.0
			SpinJitter		0.35 0.25 0.15

			InitialVelocity		0.0 0.6 -0.2
			InitialVelocityJitter	0.2 0.3 0.3
