...
###########################################################
	...
	End
		...
		Event
			...
			End
			Part Emotes\Fireworks\Rocket_Head_Sparks_Long_RED.part
			Part Emotes\Fireworks\Rocket_Trail_Sparks_RED.part
			LifeSpan 23
			LifeSpanJitter 3
		End
		...
		Event
			...
			#	Spin 0.0 1.0 0.0
				SpinJitter 0.0 0.35 0.0
			End
			Part Emotes\Fireworks\Rocket_Head_Main_RED.part
			Part Emotes\Fireworks\Rocket_Head_Sparks_RED.part
			Part Emotes\Fireworks\Rocket_Head_Trail_Glow_RED.part
			Part Emotes\Fireworks\Rocket_Trail_Smoke_RED.part
			LifeSpan 18
			LifeSpanJitter 3
		End
