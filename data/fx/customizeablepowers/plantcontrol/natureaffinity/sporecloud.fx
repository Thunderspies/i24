...
###########################################################
	...
	Condition
		...
		Event
			...
			EName FogRing1
			Bhvr behaviors/genericparticlefade.bhvr
			Part CustomizeablePowers\PlantControl\NatureAffinity\Spore_RingSmall.part
			Part CustomizeablePowers\PlantControl\NatureAffinity\Spore_DebuffSpores_RadOut.part
		End
		...
		Event
			...
			End
			Part CustomizeablePowers\PlantControl\NatureAffinity\Spore_DebuffGlow_Big.part
			Part CustomizeablePowers\PlantControl\NatureAffinity\Spore_DebuffSpores_Big.part
		End
