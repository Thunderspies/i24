...
###########################################################
	...
	Condition
		...
		Event
			...
			Part ENEMYFX\Praetorian\SpiritStalkers\Judgment_Pyronic_AreaAmber.part
			Part CustomizeablePowers\MartialAssault\Subtractive\AreaFireB.part
			Part CustomizeablePowers\MartialAssault\Subtractive\AreaFireB_Mult.part
			Part CustomizeablePowers\MartialAssault\Subtractive\AreaFire.part
			Part CustomizeablePowers\MartialAssault\Subtractive\AreaFire_Mult.part
			Part ENEMYFX\Praetorian\SpiritStalkers\Judgment_Pyronic_AreaAshes.part
		...
		Event
			...
			Type StartPositOnly
			EName FireBallHit
			Part CustomizeablePowers\MartialAssault\Subtractive\Smoke.part
			#Part ENEMYFX\Praetorian\SpiritStalkers\Judgment_Pyronic_Smoke.part
		End
